...
const H1 = ({ className, children }: IHeadingComponentProps) => {
  return (
    <h1 className={"text-3xl sm:text-4xl md:text-5xl lg:text-6xl " + className}>
      {children}
    </h1>
  );
};
...
const H2 = ({ className, children }: IHeadingComponentProps) => {
  return (
    <h2 className={"text-2xl sm:text-3xl md:text-4xl lg:text-5xl " + className}>
      {children}
    </h2>
  );
};
...
const H3 = ({ className, children }: IHeadingComponentProps) => {
  return (
    <h3 className={"text-xl sm:text-2xl md:text-3xl lg:text-4xl " + className}>
      {children}
    </h3>
  );
};
...
const H4 = ({ className, children }: IHeadingComponentProps) => {
  return (
    <h4 className={"text-lg sm:text-xl md:text-2xl lg:text-3xl " + className}>
      {children}
    </h4>
  );
};
